...
# The text file includes a single column of data including first of all every time step followed by the amplitudes of the mid point for each loading time
